...
(function($PS) {
  ...
  var printHelp = Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)(""))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("Reveal a cell by typing \"reveal x y\" where x and y form coordinates in the grid."))(function () {
...
(function($PS) {
  ...
  var main = function __do() {
      ...
      return furtherValidation(baseConfig)(function (resultConfig) {
          return function __do() {
              var consoleInterface = Node_ReadLine.createConsoleInterface(Node_ReadLine.noCompletion)();
              return Effect_Aff.launchAff_(Minesweeper_Game.startGame(resultConfig)(consoleInterface))();
          };
      })();
  };
  exports["main"] = main;
