...
(function($PS) {
  ...
  var main = function __do() {
      var v = Options_Applicative_Extra.execParser(configInfo)();
      var consoleInterface = Node_ReadLine.createConsoleInterface(Node_ReadLine.noCompletion)();
      var config = {
          gridWidth: v.value0.gridWidth,
          gridHeight: v.value0.gridHeight,
          qtyMines: v.value0.qtyMines,
          xs: Data_List.range(0)(v.value0.gridWidth - 1 | 0),
          ys: Data_List.range(0)(v.value0.gridHeight - 1 | 0)
      };
      return Effect_Aff.launchAff_(Minesweeper_Game.startGame(config)(consoleInterface))();
  };
  exports["main"] = main;
