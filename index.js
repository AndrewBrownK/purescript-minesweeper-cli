...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Minesweeper.Model"] = $PS["Minesweeper.Model"] || {};
  var exports = $PS["Minesweeper.Model"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_List = $PS["Data.List"];                    
  var Reveal = (function () {
  ...
  var Flag = (function () {
      function Flag(value0) {
          this.value0 = value0;
      };
      Flag.create = function (value0) {
          return new Flag(value0);
      };
      return Flag;
  })();
  ...
  var Revealed = (function () {
      function Revealed(value0) {
          this.value0 = value0;
      };
      Revealed.create = function (value0) {
          return new Revealed(value0);
      };
      return Revealed;
  })();
  var Exploded = (function () {
      ...
      Exploded.value = new Exploded();
      return Exploded;
  })();   
  var coordNeighbors = function (v) {
  ...
  exports["Revealed"] = Revealed;
  exports["Exploded"] = Exploded;
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Minesweeper.Render"] = $PS["Minesweeper.Render"] || {};
  var exports = $PS["Minesweeper.Render"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_Functor = $PS["Data.Functor"];
  ...
  var Minesweeper_Model = $PS["Minesweeper.Model"];                
  var showCell = function (v) {
      if (v instanceof Minesweeper_Model.Hidden && v.value0.flagged) {
          return "(F)";
      };
      if (v instanceof Minesweeper_Model.Hidden && !v.value0.flagged) {
          return "[ ]";
      };
      if (v instanceof Minesweeper_Model.Revealed && v.value0.bombNeighbors === 0) {
          return "   ";
      };
      if (v instanceof Minesweeper_Model.Revealed) {
          return " " + (Data_Show.show(Data_Show.showInt)(v.value0.bombNeighbors) + " ");
      };
      if (v instanceof Minesweeper_Model.Exploded) {
          return " * ";
      };
      throw new Error("Failed pattern match at Minesweeper.Render (line 31, column 1 - line 31, column 32): " + [ v.constructor.name ]);
  };
  var printIntroduction = Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("Welcome to Minesweeper!"))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("There is grid of x y coordinates."))(function () {
          return Effect_Class_Console.log(Effect_Aff.monadEffectAff)("The x-axis is horizontal, the y-axis is vertical.");
      });
  });
  var printHelp = Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)(""))(function () {
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("Show a cell by typing \"show x y\" where x and y form coordinates in the grid."))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("Flag a cell as a bomb by typing \"flag x y\" where x and y form coordinates in the grid."))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("Restart a new game by typing \"restart\""))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("Quit by typing \"quit\""))(function () {
  ...
  var padYAxis = function (i) {
      var str = Data_Show.show(Data_Show.showInt)(i) + " ";
  ...
  var showRow = function (config) {
      return function (gameState) {
          return function (y) {
              return padYAxis(y) + Data_Foldable.foldl(Data_List_Types.foldableList)(function (str) {
                  return function (x) {
                      return str + Data_Maybe.fromMaybe("[ ]")(Data_Functor.map(Data_Maybe.functorMaybe)(showCell)(Data_Map_Internal.lookup(Data_Ord.ordRecord()(Data_Ord.ordRecordCons(Data_Ord.ordRecordCons(Data_Ord.ordRecordNil)()(new Data_Symbol.IsSymbol(function () {
                          return "y";
  ...
  var printGameState = function (config) {
      return function (gameState) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Class_Console.clear(Effect_Class.monadEffectEffect)))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(printIntroduction)(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(printHelp)(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Data_Foldable.foldr(Data_List_Types.foldableList)(function (y) {
                          return function (aff) {
                              return Data_Semigroup.append(Effect_Aff.semigroupAff(Data_Semigroup.semigroupUnit))(aff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)(showRow(config)(gameState)(y)));
                          };
                      })(Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Unit.unit))(config.ys))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("   " + Data_Foldable.foldMap(Data_List_Types.foldableList)(Data_Monoid.monoidString)(padXAxis)(config.xs)))(function () {
                              return Effect_Class_Console.log(Effect_Aff.monadEffectAff)("");
                          });
                      });
                  });
...
(function($PS) {
  ...
  var prompt = function (dictMonadAff) {
      return function ($$interface) {
          var go = function (handler) {
              return function __do() {
                  Node_ReadLine.setLineHandler($$interface)(function ($5) {
                      return handler(Data_Either.Right.create($5));
                  })();
                  Node_ReadLine.prompt($$interface)();
                  return Effect_Aff.nonCanceler;
              };
          };
          return Effect_Aff_Class.liftAff(dictMonadAff)(Effect_Aff.makeAff(go));
      };
  };
...
(function($PS) {
  // Generated by purs version 0.13.6
  "use strict";
  $PS["Minesweeper.Game"] = $PS["Minesweeper.Game"] || {};
  var exports = $PS["Minesweeper.Game"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Array = $PS["Data.Array"];
  var Data_Foldable = $PS["Data.Foldable"];
  ...
  var Minesweeper_Model = $PS["Minesweeper.Model"];
  var Minesweeper_Render = $PS["Minesweeper.Render"];
  var Node_Process = $PS["Node.Process"];
  var Node_ReadLine_Aff = $PS["Node.ReadLine.Aff"];                
  var setBomb = function (coord) {
      return function (map) {
          return Data_Maybe.fromMaybe(map)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Data_Ord.ordRecord()(Data_Ord.ordRecordCons(Data_Ord.ordRecordCons(Data_Ord.ordRecordNil)()(new Data_Symbol.IsSymbol(function () {
              return "y";
          }))(Data_Ord.ordInt))()(new Data_Symbol.IsSymbol(function () {
              return "x";
          }))(Data_Ord.ordInt)))(coord)(map))(function (existing) {
              if (existing instanceof Minesweeper_Model.Hidden) {
                  return Data_Maybe.Just.create(Data_Map_Internal.insert(Data_Ord.ordRecord()(Data_Ord.ordRecordCons(Data_Ord.ordRecordCons(Data_Ord.ordRecordNil)()(new Data_Symbol.IsSymbol(function () {
                      return "y";
                  }))(Data_Ord.ordInt))()(new Data_Symbol.IsSymbol(function () {
                      return "x";
                  }))(Data_Ord.ordInt)))(coord)(new Minesweeper_Model.Hidden({
                      flagged: existing.value0.flagged,
                      bomb: true
                  }))(map));
              };
              return Data_Maybe.Nothing.value;
  ...
  var interpretInput = function (line) {
      var readTwoInts = function (args) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(args)(1))(function (x$prime) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(args)(2))(function (y$prime) {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Int.fromString(x$prime))(function (x) {
                      return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Int.fromString(y$prime))(function (y) {
      ...
      return Data_Maybe.fromMaybe(Minesweeper_Model.Help.value)((function () {
          var lineElements = Data_String_Common.split(" ")(line);
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.index(lineElements)(0))(function (command) {
              var v = Data_String_Common.toLower(command);
              if (v === "quit") {
                  return new Data_Maybe.Just(Minesweeper_Model.Quit.value);
              };
              if (v === "restart") {
                  return new Data_Maybe.Just(Minesweeper_Model.Restart.value);
              };
              if (v === "show") {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(readTwoInts(lineElements))(function (twoInts) {
                      return Data_Maybe.Just.create(new Minesweeper_Model.Reveal(twoInts));
                  });
              };
              if (v === "flag") {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(readTwoInts(lineElements))(function (twoInts) {
                      return Data_Maybe.Just.create(new Minesweeper_Model.Flag(twoInts));
                  });
              };
              return Data_Maybe.Nothing.value;
          });
  ...
  var flagCheat = function (v) {
      if (v instanceof Minesweeper_Model.Hidden && v.value0.bomb) {
          return new Minesweeper_Model.Hidden({
              bomb: true,
              flagged: true
          });
      };
  ...
  var flagCell = function (coord) {
      return function (gameState) {
          return Data_Maybe.fromMaybe(gameState)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Data_Ord.ordRecord()(Data_Ord.ordRecordCons(Data_Ord.ordRecordCons(Data_Ord.ordRecordNil)()(new Data_Symbol.IsSymbol(function () {
              return "y";
          }))(Data_Ord.ordInt))()(new Data_Symbol.IsSymbol(function () {
              return "x";
          }))(Data_Ord.ordInt)))(coord)(gameState.grid))(function (cellState) {
              var newCellState = (function () {
                  if (cellState instanceof Minesweeper_Model.Hidden && !cellState.value0.flagged) {
                      return new Minesweeper_Model.Hidden({
                          bomb: cellState.value0.bomb,
                          flagged: true
                      });
                  };
                  if (cellState instanceof Minesweeper_Model.Hidden && cellState.value0.flagged) {
              ...
              var newGrid = Data_Map_Internal.insert(Data_Ord.ordRecord()(Data_Ord.ordRecordCons(Data_Ord.ordRecordCons(Data_Ord.ordRecordNil)()(new Data_Symbol.IsSymbol(function () {
                  return "y";
              }))(Data_Ord.ordInt))()(new Data_Symbol.IsSymbol(function () {
                  return "x";
  ...
  var explode = function (v) {
      if (v instanceof Minesweeper_Model.Hidden && v.value0.bomb) {
          return Minesweeper_Model.Exploded.value;
      };
      return v;
  };
  ...
  var createBombCoords = function (config) {
      return function (forbidden) {
          return function (existing) {
              var filtered = Data_Set["delete"](Data_Ord.ordRecord()(Data_Ord.ordRecordCons(Data_Ord.ordRecordCons(Data_Ord.ordRecordNil)()(new Data_Symbol.IsSymbol(function () {
                  return "y";
              }))(Data_Ord.ordInt))()(new Data_Symbol.IsSymbol(function () {
                  return "x";
              }))(Data_Ord.ordInt)))(forbidden)(existing);
              var v = Data_Set.size(filtered) < config.qtyMines;
              if (!v) {
                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(filtered);
              };
              if (v) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Random.randomInt(0)(config.gridWidth - 1 | 0)))(function (x) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Random.randomInt(0)(config.gridHeight - 1 | 0)))(function (y) {
                          return createBombCoords(config)(forbidden)(Data_Set.insert(Data_Ord.ordRecord()(Data_Ord.ordRecordCons(Data_Ord.ordRecordCons(Data_Ord.ordRecordNil)()(new Data_Symbol.IsSymbol(function () {
                              return "y";
                          }))(Data_Ord.ordInt))()(new Data_Symbol.IsSymbol(function () {
                              return "x";
                          }))(Data_Ord.ordInt)))({
              ...
              throw new Error("Failed pattern match at Minesweeper.Game (line 129, column 6 - line 134, column 71): " + [ v.constructor.name ]);
          };
      };
  };
  var initializeBombs = function (config) {
  ...
  var revealCell = function (config) {
      return function (coord) {
          return function (gameState) {
              return Data_Maybe.fromMaybe(gameState)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Data_Ord.ordRecord()(Data_Ord.ordRecordCons(Data_Ord.ordRecordCons(Data_Ord.ordRecordNil)()(new Data_Symbol.IsSymbol(function () {
                  return "y";
                  ...
                  return Control_Applicative.pure(Data_Maybe.applicativeMaybe)((function () {
                      if (cellState instanceof Minesweeper_Model.Exploded) {
                          return gameState;
                      };
                      if (cellState instanceof Minesweeper_Model.Revealed) {
                          return gameState;
                      };
                      if (cellState instanceof Minesweeper_Model.Hidden && cellState.value0.flagged) {
                          return gameState;
                      };
                      if (cellState instanceof Minesweeper_Model.Hidden && cellState.value0.bomb) {
                          return revealBombs(gameState);
                      };
                      if (cellState instanceof Minesweeper_Model.Hidden) {
                          var adjacentCoords = Minesweeper_Model.coordNeighbors(coord);
                          var adjacentCellStates = Data_List.catMaybes(Data_Functor.map(Data_List_Types.functorList)(function (c) {
                              return Data_Map_Internal.lookup(Data_Ord.ordRecord()(Data_Ord.ordRecordCons(Data_Ord.ordRecordCons(Data_Ord.ordRecordNil)()(new Data_Symbol.IsSymbol(function () {
                                  return "y";
                              }))(Data_Ord.ordInt))()(new Data_Symbol.IsSymbol(function () {
                                  return "x";
                              }))(Data_Ord.ordInt)))(c)(gameState.grid);
                          })(adjacentCoords));
                          var bombNeighbors = Data_Foldable.foldr(Data_List_Types.foldableList)(function (adjacentState) {
                              return function (count) {
                                  return count + countBomb(adjacentState) | 0;
                              };
                          })(0)(adjacentCellStates);
                          var grid = Data_Map_Internal.insert(Data_Ord.ordRecord()(Data_Ord.ordRecordCons(Data_Ord.ordRecordCons(Data_Ord.ordRecordNil)()(new Data_Symbol.IsSymbol(function () {
                              return "y";
                          }))(Data_Ord.ordInt))()(new Data_Symbol.IsSymbol(function () {
                              return "x";
                          }))(Data_Ord.ordInt)))(coord)(new Minesweeper_Model.Revealed({
                          ...
                          var newNewGameState = (function () {
                              var $40 = newGameState.hiddenCells <= config.qtyMines;
                              if ($40) {
                          ...
                          if (bombNeighbors === 0) {
                              return Data_Foldable.foldr(Data_List_Types.foldableList)(revealCell(config))(newNewGameState)(adjacentCoords);
                          };
                          return newNewGameState;
                      };
                      throw new Error("Failed pattern match at Minesweeper.Game (line 149, column 8 - line 165, column 31): " + [ cellState.constructor.name ]);
                  })());
              }));
          };
      };
  ...
  var startGame = function (config) {
      return function (consoleInterface) {
          var defaultCell = new Minesweeper_Model.Hidden({
              bomb: false,
              flagged: false
          });
          var grid = Data_Foldable.foldr(Data_List_Types.foldableList)(function (y) {
              return function (m) {
          ...
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Minesweeper_Render.printGameState(config)(gameState))(function () {
              return loop({
                  gameState: gameState,
  ...
  var loop = function (loopState) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Node_ReadLine_Aff.prompt(Effect_Aff_Class.monadAffAff)(loopState.consoleInterface))(function (rawInput) {
          return handleAction(loopState)(interpretInput(rawInput));
      });
  };
  var handleWin = function (loopState) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("You win! Congratulations! B)"))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("Press enter to restart."))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)(""))(function () {
                  return coerceRestartOrQuit(loopState);
              });
          });
      });
  };
  var handleLoss = function (loopState) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("Sorry, you lose :("))(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("Press enter to restart."))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class_Console.log(Effect_Aff.monadEffectAff)(""))(function () {
                  return coerceRestartOrQuit(loopState);
              });
  ...
  var handleAction = function (v) {
      return function (v1) {
          if (v1 instanceof Minesweeper_Model.Quit) {
              return Data_Semigroup.append(Effect_Aff.semigroupAff(Data_Semigroup.semigroupUnit))(Effect_Class_Console.log(Effect_Aff.monadEffectAff)("Thank you for playing! Bye-bye."))(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Node_Process.exit(0)));
          };
          if (v1 instanceof Minesweeper_Model.Restart) {
              return startGame(v.config)(v.consoleInterface);
          };
          if (v1 instanceof Minesweeper_Model.Help) {
              return Data_Semigroup.append(Effect_Aff.semigroupAff(Data_Semigroup.semigroupUnit))(Minesweeper_Render.printHelp)(loop(v));
          };
          if (v1 instanceof Minesweeper_Model.Flag) {
              var $45 = v1.value0.x < 0 || (v1.value0.x >= v.config.gridWidth || (v1.value0.y < 0 || v1.value0.y >= v.config.gridHeight));
              if ($45) {
                  return Data_Semigroup.append(Effect_Aff.semigroupAff(Data_Semigroup.semigroupUnit))(Minesweeper_Render.printHelp)(loop(v));
              };
              var newState = flagCell(v1.value0)(v.gameState);
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Class_Console.clear(Effect_Class.monadEffectEffect)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Minesweeper_Render.printGameState(v.config)(newState))(function () {
                      return loop({
                          gameState: newState,
                          consoleInterface: v.consoleInterface,
                          config: v.config
                      });
                  });
              });
          };
          if (v1 instanceof Minesweeper_Model.Reveal) {
              var $49 = v1.value0.x < 0 || (v1.value0.x >= v.config.gridWidth || (v1.value0.y < 0 || v1.value0.y >= v.config.gridHeight));
              if ($49) {
                  return Data_Semigroup.append(Effect_Aff.semigroupAff(Data_Semigroup.semigroupUnit))(Minesweeper_Render.printHelp)(loop(v));
              };
              if (v.gameState.lost) {
              ...
              if (!v.gameState.firstRevealDone) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(initializeBombs(v.config)(v1.value0)(v.gameState))(function (newState) {
                      return handleAction({
                          gameState: newState,
                          consoleInterface: v.consoleInterface,
                          config: v.config
                      })(new Minesweeper_Model.Reveal(v1.value0));
                  });
              };
              var newState = revealCell(v.config)(v1.value0)(v.gameState);
              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Class_Console.clear(Effect_Class.monadEffectEffect)))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Minesweeper_Render.printGameState(v.config)(newState))(function () {
                      if (newState.lost) {
                          return handleLoss(v);
                      };
                      var $54 = newState.hiddenCells <= v.config.qtyMines;
                      if ($54) {
                          return handleWin(v);
                      };
                      return loop({
          ...
          throw new Error("Failed pattern match at Minesweeper.Game (line 72, column 1 - line 72, column 52): " + [ v.constructor.name, v1.constructor.name ]);
      };
  };
  var coerceRestartOrQuit = function (loopState) {
      return Control_Bind.bind(Effect_Aff.bindAff)(Node_ReadLine_Aff.prompt(Effect_Aff_Class.monadAffAff)(loopState.consoleInterface))(function (rawInput) {
          var action = interpretInput(rawInput);
          if (action instanceof Minesweeper_Model.Quit) {
              return handleAction(loopState)(Minesweeper_Model.Quit.value);
          };
          return handleAction(loopState)(Minesweeper_Model.Restart.value);
      });
  };
...
(function($PS) {
  ...
  var Effect_Class = $PS["Effect.Class"];
  var Effect_Class_Console = $PS["Effect.Class.Console"];
  var Minesweeper_Game = $PS["Minesweeper.Game"];
  var Minesweeper_Model = $PS["Minesweeper.Model"];
  var Node_ReadLine = $PS["Node.ReadLine"];
  var Options_Applicative_Builder = $PS["Options.Applicative.Builder"];
  var Options_Applicative_Builder_Internal = $PS["Options.Applicative.Builder.Internal"];
  ...
  var furtherValidation = function (v) {
      return function (andThen) {
          var checkWidth = function (w) {
              var $9 = w <= 0;
              if ($9) {
                  return Data_Validation_Semigroup.invalid([ "The width must be greater than 0." ]);
              };
              var $10 = w > 99;
              if ($10) {
                  return Data_Validation_Semigroup.invalid([ "The width must be less than 99." ]);
              };
              return Data_Validation_Semigroup.V(new Data_Either.Right(w));
          };
          var checkQtyMines = function (w) {
              return function (h) {
                  return function (m) {
                      var $11 = m < 0;
                      if ($11) {
                          return Data_Validation_Semigroup.invalid([ "The number of mines cannot be negative." ]);
                      };
                      var $12 = m >= (w * h | 0);
                      if ($12) {
                          return Data_Validation_Semigroup.invalid([ "There are too many mines (" + (Data_Show.show(Data_Show.showInt)(m) + (") for the provided area " + (Data_Show.show(Data_Show.showInt)(w) + (" x " + (Data_Show.show(Data_Show.showInt)(h) + "."))))) ]);
                      };
                      return Data_Validation_Semigroup.V(new Data_Either.Right(m));
                  };
              };
          };
          var checkHeight = function (h) {
              var $13 = h <= 0;
              if ($13) {
                  return Data_Validation_Semigroup.invalid([ "The height must be greater than 0." ]);
              };
              var $14 = h > 99;
              if ($14) {
                  return Data_Validation_Semigroup.invalid([ "The height must be less than 99." ]);
              };
              return Data_Validation_Semigroup.V(new Data_Either.Right(h));
          };
          return Data_Validation_Semigroup.unV(function (errs) {
              return Data_Foldable.foldMap(Data_Foldable.foldableArray)(Effect.monoidEffect(Data_Monoid.monoidUnit))(Effect_Class_Console.log(Effect_Class.monadEffectEffect))(errs);
          })(function (c) {
              return andThen(Record.merge()()(c)({
                  xs: Data_List.range(0)(c.gridWidth - 1 | 0),
                  ys: Data_List.range(0)(c.gridHeight - 1 | 0)
              }));
          })(Control_Apply.apply(Data_Validation_Semigroup.applyV(Data_Semigroup.semigroupArray))(Control_Apply.apply(Data_Validation_Semigroup.applyV(Data_Semigroup.semigroupArray))(Data_Functor.map(Data_Validation_Semigroup.functorV)(function (v1) {
              return function (v2) {
                  return function (v3) {
                      return {
                          gridWidth: v1,
          ...
          })(checkWidth(v.value0.gridWidth)))(checkHeight(v.value0.gridHeight)))(checkQtyMines(v.value0.gridWidth)(v.value0.gridHeight)(v.value0.qtyMines)));
      };
  };
  var configParser = Control_Apply.apply(Options_Applicative_Types.parserApply)(Control_Apply.apply(Options_Applicative_Types.parserApply)(Data_Functor.map(Options_Applicative_Types.parserFunctor)(function (v) {
      return function (v1) {
          return function (v2) {
              return new Minesweeper_Model.Config({
                  gridWidth: v,
                  gridHeight: v1,
                  qtyMines: v2
              });
  ...
  })(Options_Applicative_Builder.option(Options_Applicative_Builder["int"])(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["long"](Options_Applicative_Builder_Internal.optionFieldsHasName)("width"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["short"](Options_Applicative_Builder_Internal.optionFieldsHasName)("w"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.help("Width of the grid (in columns)."))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.showDefault(Data_Show.showInt))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.value(Options_Applicative_Builder_Internal.optionFieldsHasValue)(10))(Options_Applicative_Builder.metavar(Options_Applicative_Builder_Internal.optionFieldsHasMetavar)("INT")))))))))(Options_Applicative_Builder.option(Options_Applicative_Builder["int"])(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["long"](Options_Applicative_Builder_Internal.optionFieldsHasName)("height"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["short"](Options_Applicative_Builder_Internal.optionFieldsHasName)("h"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.help("Height of the grid (in rows)."))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.showDefault(Data_Show.showInt))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.value(Options_Applicative_Builder_Internal.optionFieldsHasValue)(10))(Options_Applicative_Builder.metavar(Options_Applicative_Builder_Internal.optionFieldsHasMetavar)("INT")))))))))(Options_Applicative_Builder.option(Options_Applicative_Builder["int"])(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["long"](Options_Applicative_Builder_Internal.optionFieldsHasName)("mines"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder["short"](Options_Applicative_Builder_Internal.optionFieldsHasName)("m"))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.help("The number of mines to sweep."))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.showDefault(Data_Show.showInt))(Data_Semigroup.append(Options_Applicative_Builder_Internal.modSemigroup)(Options_Applicative_Builder.value(Options_Applicative_Builder_Internal.optionFieldsHasValue)(10))(Options_Applicative_Builder.metavar(Options_Applicative_Builder_Internal.optionFieldsHasMetavar)("INT"))))))));
  var configInfo = Options_Applicative_Builder.info(Options_Applicative_Internal_Utils.apApplyFlipped(Options_Applicative_Types.parserApply)(configParser)(Options_Applicative_Extra.helper))(Options_Applicative_Builder.progDesc("Play minesweeper on the command line."));
  var completer = function (input) {
      var match = Data_Foldable.find(Data_Foldable.foldableArray)(Data_String_Utils.startsWith(input))([ "show ", "flag ", "quit ", "restart ", "help " ]);
      if (match instanceof Data_Maybe.Just) {
          return Control_Applicative.pure(Effect.applicativeEffect)({
              completions: [ match.value0 ],
              matched: input
          });
      };
      ...
      throw new Error("Failed pattern match at Main (line 92, column 6 - line 94, column 52): " + [ match.constructor.name ]);
  };
  var main = function __do() {
      var baseConfig = Options_Applicative_Extra.execParser(configInfo)();
      return furtherValidation(baseConfig)(function (validConfig) {
          return function __do() {
              var consoleInterface = Node_ReadLine.createConsoleInterface(completer)();
              return Effect_Aff.launchAff_(Minesweeper_Game.startGame(validConfig)(consoleInterface))();
          };
      })();
  };
  exports["main"] = main;
  exports["furtherValidation"] = furtherValidation;
